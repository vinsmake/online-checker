 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Ac;function Fp(){if(Ac)return $r;Ac=1;var o=Dl(),a=Symbol.for("react.element"),s=Symbol.for("react.fragment"),u=Object.prototype.hasOwnProperty,d=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,f={key:!0,ref:!0,__self:!0,__source:!0};function h(x,E,w){var _,C={},L=null,W=null;w!==void 0&&(L=""+w),E.key!==void 0&&(L=""+E.key),E.ref!==void 0&&(W=E.ref);for(_ in E)u.call(E,_)&&!f.hasOwnProperty(_)&&(C[_]=E[_]);if(x&&x.defaultProps)for(_ in E=x.defaultProps,E)C[_]===void 0&&(C[_]=E[_]);return{$$typeof:a,type:x,key:L,ref:W,props:C,_owner:d.current}}return $r.Fragment=s,$r.jsx=h,$r.jsxs=h,$r}var Lc;function jp(){return Lc||(Lc=1,gl.exports=Fp()),gl.exports}var ee=jp(),Ot=Dl();const mn=Lp(Ot);var li={},vl={exports:{}},Ge={},bl={exports:{}},xl={};/**
 * @license React
...
}`);var tr=Array.from({length:4},function(o,a){return"--life-line-phase".concat(a+1,"-color")}),jd=function(o){var a,s=Ad(o==null?void 0:o.style,o==null?void 0:o.size),u=s.styles,d=s.fontSize,f=o==null?void 0:o.easing,h=Dd(o==null?void 0:o.speedPlus,"2s").animationPeriod,x=function(E){var w={};if(E instanceof Array){for(var _=Fd(E,tr.length),C=0;C<_.length&&!(C>=4);C++)w[tr[C]]=_[C];return w}try{if(typeof E!="string")throw new Error("Color String expected");for(var L=0;L<tr.length;L++)w[tr[L]]=E}catch(W){for(W instanceof Error?console.warn("[".concat(W.message,']: Received "').concat(typeof E,'" instead with value, ').concat(JSON.stringify(E))):console.warn("".concat(JSON.stringify(E)," received in <LifeLine /> indicator cannot be processed. Using default instead!")),L=0;L<tr.length;L++)w[tr[L]]=Md}return w}((a=o==null?void 0:o.color)!==null&&a!==void 0?a:"");return mn.createElement("span",{className:"rli-d-i-b lifeline-rli-bounding-box",style:Ve(Ve(Ve(Ve(Ve({},d&&{fontSize:d}),h&&{"--rli-animation-duration":h}),f&&{"--rli-animation-function":f}),x),u),role:"status","aria-live":"polite","aria-label":"Loading"},mn.createElement("span",{className:"rli-d-i-b lifeline-indicator"},mn.createElement("svg",{width:"14em",height:"6.825000001em",xmlns:"http://www.w3.org/2000/svg",version:"1.2",viewBox:"0 0 350 50",preserveAspectRatio:"xMinYMin meet"},mn.createElement("path",{className:"rli-lifeline",stroke:"currentColor",fill:"none",strokeLinejoin:"round",strokeWidth:"4px",d:"M-113 70h250q8-30 12-3t5 8 3-7 3 4 6 35 8-55 6 40 8-3s2-11 10-10 1 1 8-10l4 8c6 4 8-6 10-17s2 10 9 11h210"}))),mn.createElement(Ld,{staticText:!0,text:o==null?void 0:o.text,textColor:o==null?void 0:o.textColor}))};const Fm=()=>ee.jsx("div",{className:"flex flex-col items-center justify-center w-screen h-screen bg-gray-50 text-center",children:ee.jsx(jd,{color:"#3030cc",size:"large",text:"Se están revisando las webs...",textColor:""})}),jm=()=>ee.jsx("div",{className:"flex flex-col items-center justify-center w-screen h-screen bg-gray-50 text-center",children:ee.jsx(jd,{color:"#cc3030",size:"large",text:"Ha ocurrido un error, reinentando...",textColor:""})}),Im=()=>ee.jsxs("div",{className:"flex flex-col items-center justify-center w-screen h-screen bg-gray-50 text-center text-red-600 text-xl font-medium	",children:[ee.jsx(Mm,{color:"#cc3030",size:"large",text:"Error en el servidor, reinentando...",textColor:""}),ee.jsx("p",{children:"Si el error persiste"}),ee.jsx("p",{children:"Favor de contactar al administrador"})]}),qm=()=>{const o="https://online-checker.onrender.com",[a,s]=Ot.useState([]),[u,d]=Ot.useState(!0),[f,h]=Ot.useState(!1),[x,E]=Ot.useState(!1),w=Ot.useRef(0),_=3,C=6;return Ot.useEffect(()=>{const L=async()=>{try{const W=await Te.get(`${o}/api/check`);s(W.data),w.current=0,d(!1),h(!1),E(!1),setTimeout(L,6e4),console.log("Data fetched")}catch(W){console.error("Error fetching data:",W),w.current<=_?(console.log(`Reintentando... (${w.current+1}/${_})`),setTimeout(L,3e3),w.current+=1):w.current<=C?(h(!0),d(!1),console.log(`Reintentando... (${w.current+1}/${C})`),setTimeout(L,3e3),w.current+=1):(E(!0),h(!1),console.log(`Reintentando... (${w.current+1} veces)`),setTimeout(L,3e3),w.current+=1)}};L()},[]),u?ee.jsx(Fm,{}):f?ee.jsx(jm,{}):x?ee.jsx(Im,{}):ee.jsx(xm,{websites:a})},Um=()=>ee.jsx(ee.Fragment,{children:ee.jsx(qm,{})});$p.createRoot(document.getElementById("root")).render(ee.jsx(Um,{}));
